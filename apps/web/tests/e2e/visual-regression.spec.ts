...
const contentPages = [
	...
	{
		path: '/series/le-monde-du-dev-sous-choc/le-jour-ou-jai-cesse-davoir-peur-de-lia',
		name: 'series-ch01'
	},
	{ path: '/series/le-monde-du-dev-sous-choc/le-marche-se-restructure', name: 'series-ch02' },
	{
		path: '/series/le-monde-du-dev-sous-choc/et-si-le-marche-ne-suivait-plus',
		name: 'series-ch03'
	},
	{ path: '/series/le-monde-du-dev-sous-choc/ce-qui-casse-ce-qui-se-copie', name: 'series-ch04' },
	{
		path: '/series/le-monde-du-dev-sous-choc/le-piege-de-la-qualite-suffisante',
		name: 'series-ch05'
	},
	{
		path: '/series/le-monde-du-dev-sous-choc/quand-tout-le-monde-genere-qui-relit',
		name: 'series-ch06'
	},
	{ path: '/series/le-monde-du-dev-sous-choc/lia-est-faillible-et-ton-code', name: 'series-ch07' },
	{
		path: '/series/le-monde-du-dev-sous-choc/le-code-propre-n-est-pas-le-craft',
		name: 'series-ch08'
	},
	{ path: '/series/le-monde-du-dev-sous-choc/la-discipline-se-deplace', name: 'series-ch09' },
	{
		path: '/series/le-monde-du-dev-sous-choc/dou-viendront-les-devs-de-demain',
		name: 'series-ch10'
	},
