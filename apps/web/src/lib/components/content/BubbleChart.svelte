<script lang="ts">
	...
	import BubblePoints from './chart/BubblePoints.svelte';
	import Arrows from './chart/Arrows.svelte';
	...
	const { xLabel, yLabel, bubbles, quadrants, arrows = [] }: Props = $props();
</script>

<figure class="bubble-chart-wrapper">
	<div class="chart-row">
		{#if yLabel}
